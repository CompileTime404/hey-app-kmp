package com.dorianbanic.chat.presentation.chat_list_detail
...
import com.dorianbanic.chat.presentation.chat_detail.ChatDetailRoot
import com.dorianbanic.chat.presentation.chat_list.ChatListRoot
import com.dorianbanic.chat.presentation.create_chat.CreateChatRoot
import com.dorianbanic.chat.presentation.manage_chat.ManageChatRoot
import com.dorianbanic.chat.presentation.profile.ProfileRoot
import com.dorianbanic.core.desingsystem.theme.extended
import com.dorianbanic.core.presentation.util.DialogSheetScopedViewModel
...
fun ChatListDetailAdaptiveLayout(
    ...
    DialogSheetScopedViewModel(
        visible = sharedState.dialogState is DialogState.ProfileDialog
    ) {
        ProfileRoot(
            onDismiss = {
                chatListDetailViewModel.onAction(ChatListDetailAction.OnDismissCurrentDialog)
